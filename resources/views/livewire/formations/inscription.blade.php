                           ...
                           <td style="text-align: right;">
                            <div class="btn-group">
                                <button class="btn btn-sm btn-info" data-bs-toggle="modal"
                                    data-bs-target="#details-{{ $inscription->id }}">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="modal fade" id="mailModal{{ $inscription->id }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">

                                                <div class="modal-header">
                                                    <h5 class="modal-title">Envoyer un email au candidat</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $inscription->nom }}" disabled>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Email du candidat</label>
                                                        <input type="email" class="form-control"
                                                            value="{{ $inscription->email }}" disabled>
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button class="btn btn-primary"
                                                        wire:click="sendMail({{ $inscription->id }})">
                                                        Envoyer
                                                    </button>
                                                </div>
                                    ...
                                    <script>
                                        Livewire.on('mailSent', message => {
                                            ...
                                            // Optionnel : reload de la page
                                            // location.reload();
                                        });
                                    </script>

                                    <!-- ⭐ Modal détails -->
                                    <div class="modal fade" id="details-{{ $inscription->id }}" tabindex="-1"
                                        aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title">
                                                        Détails Inscription #{{ $inscription->id }}
                                                    </h5>
                                                    <button type="button" class="btn-close"
                                                        data-bs-dismiss="modal"></button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <table class="table table-striped">
                                                        ...
                                                        <tr>
                                                            <th>Pays</th>
                                                            <td>{{ $inscription->country ? $inscription->country->name : 'Non défini' }}
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $inscription->created_at->format('d/m/Y H:i') }}
                                                            </td>
                                                        </tr>

                                                        <tr>
                                                            <th>Date du début souhaitée</th>
