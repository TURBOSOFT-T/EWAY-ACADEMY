<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold text-dark mb-1">Packs de Formations</h3>
            <p class="text-muted mb-0">Gérez vos offres groupées et leurs formations associées.</p>
        </div>
        <a href="{{ route('pack.add') }}" class="btn btn-primary shadow-sm">
    ...
    <i class="fa-solid fa-pen-to-square"></i> Modifier
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm p-5 text-center">
                ...
                <div>
                    <a href="{{ route('pack.add') }}" class="btn btn-primary">
                        <i class="fa-solid fa-plus me-1"></i> Créer un Pack
                    </a>
                </div>
            </div>
